function J = expnd(I, num_rows_expanded, num_cols_expanded)

hsI = I;

for i=1:num_rows_expanded
    hseI = imenergy(hsI);
...
for d = 1:dim
    for c = 1:col
        if S(1,c) == 1
            I2(:,c,d) = [I(1,c,d); I(1:row,c,d)];
        elseif S(1,c) == row
            I2(:,c,d) = [I(1:row,c,d); I(row,c,d)];
        else
            I2(:,c,d) = [I(1:S(1,c),c,d); I(S(1,c),c,d); I(S(1,c)+1:row,c,d)];
        end
    end
end
